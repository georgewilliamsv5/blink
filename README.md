...
| `PG_SECRET_NAME` | `YOUR_PASSWORD` | Secret Manager entry that holds the DB password |
...
4. **GitHub secrets** — In addition to `GCP_SA_KEY`, add:

| Secret | Example | Purpose |
| ------ | ------- | ------- |
| `REDIS_HOST` | `YOUR_HOST` | Memorystore host IP (private) |
